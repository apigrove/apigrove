...
public class BasicCacheManager implements ICacheManager {
	...
	@Override
	public <K, V extends IAckData> IAckCacheTable<K, V> createAckTable(String name, boolean isReplicated, Map<String, String> properties) {
		return null;
	}
