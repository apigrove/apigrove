...
public class AuthIdsNoIdType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the authId property.
     * 
     * <p>
	...
	public String toString() {
		...
		builder.append("AuthIdsNoIdType [authIds=");
		builder.append(authIds);
		builder.append(", id=");
		builder.append(id);
		builder.append("]");
