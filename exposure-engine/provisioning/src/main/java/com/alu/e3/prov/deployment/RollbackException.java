...
public class RollbackException extends ProvisionException {

	private static final long serialVersionUID = -6054594686753373061L;
	
	public RollbackException(int code, String message, Throwable cause) {
	...
	public RollbackException(int code, Throwable cause) {
		super(code, cause);
	}
